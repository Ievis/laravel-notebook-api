...
class StoreNotebookRecordRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'phone_number' => 'required|string|max:255|unique:notebook_records',
            'email' => 'required|email|string|max:255|unique:notebook_records',
            'birthday' => '',
            'company' => '',
            'image' => ''
        ];
